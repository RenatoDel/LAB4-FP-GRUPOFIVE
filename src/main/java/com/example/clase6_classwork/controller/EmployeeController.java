...
import com.example.clase6_classwork.repository.DepartmentsRepository;
import com.example.clase6_classwork.repository.EmployeesRepository;
import com.example.clase6_classwork.repository.JobsRepository;
...
public class EmployeeController {
    ...
    public String nuevoEmployeeForm(Model model, @ModelAttribute("employee") Employees employees) {
